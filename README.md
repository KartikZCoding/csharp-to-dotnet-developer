...
Rather than uploading random code, I designed my GitHub profile to clearly show:

- 📈 My progress from **scratch to .NET Developer**
- 🧠 Strong conceptual understanding of **C# and OOP**
- 🛠️ Practical learning through **console applications**
- 📚 Well-organized learning notes using **Markdown**

This repository acts as a **central menu (index)** to easily navigate all my learning repositories.
...
⭐ Feel free to explore the repositories and follow my learning journey!
